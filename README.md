# OneWire for the RPi Pico and Pico 2 'C' SDK
...
Note that anyone cloning your repositiory should now use `git clone --recursive` so they also fetch the submodule.
